    ...
    const content = (
      <div className="relative mt-6 aspect-4/2.5 w-full overflow-hidden rounded-xl border md:-mx-1">
        <Image
          ...
          width={1440}
          height={900}
          className="absolute top-0 left-0 z-20 w-242.5 max-w-none bg-background sm:w-7xl md:hidden dark:hidden md:dark:hidden"
        />
        <Image
          ...
          width={1440}
          height={900}
          className="absolute top-0 left-0 z-20 hidden w-242.5 max-w-none bg-background sm:w-7xl md:hidden dark:block md:dark:hidden"
        />
        <div className="absolute inset-0 hidden w-400 bg-background md:block">
