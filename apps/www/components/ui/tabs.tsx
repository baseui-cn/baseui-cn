...
export type TabsVariant = "default" | "underline" | "line"
...
export function TabsList({
  ...
  const resolvedVariant = variant === "line" ? "underline" : variant
    ...
    <TabsPrimitive.List
      className={cn(
        ...
        resolvedVariant === "default"
          ...
          : "data-[orientation=vertical]:px-1 data-[orientation=horizontal]:py-1 *:data-[slot=tabs-tab]:hover:bg-muted",
        className
      )}
      data-slot="tabs-list"
      {...props}
